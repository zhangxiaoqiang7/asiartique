...
<header>
      ...
      <div class="container-fluid">
        <div class="navbar-header">
              <a class="navbar-brand" href="#">
                         <img src="images/index/index.png"  alt=" logo" class="hidden-xs hidden-sm">
                           <img src="images/index/index.png"  alt=" logo" class="visible-xs visible-sm"><span class="sr-only"></span>
                    </a>
  ...
  <div class="container">
     ...
     <div class="list-group">
         <div class=" col-sm-12" id = "articles">
         <!--content-->
        </div>
     </div>
     </div>
...
_________________________________________________________ -->
    ...
    <script type="text/javascript" src="myjs/default.js"></script>

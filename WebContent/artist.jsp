    ...
    <div class="container mincontent">
          ...
          <div class="page-header">
            ...
            <div>
              <!--button class="btn btn-primary" type="button">
               FOLLOW <span class="badge">4</span>
              </button-->
            </div>
          </div>
      ...
      <!--暂时隐藏-->
        <!--div class="col-xs-6 col-md-6">
          <h4>Biography</h4>
          <P id="artdes" class="text-justify"></P>

          <p>Colombian, b. 1982, Bogota, Colombia</p>
        </div >
        ...
        <div class="col-md-12" id="gradient"></div>
        </div>
      <div class="row clearfix">
        <div class="col-xs-5"><hr></div>
        <div class="col-xs-2 text-center" id="read-more" style="padding-top: 10px"></div>
        <div class="col-xs-5"><hr></div>
      </div -->
      <div class="row clearfix" style="padding-bottom: 10px;padding-top: 10px">
        <div class="col-xs-5">
          <label id="workcount"></label>
        </div>
        <div class="col-xs-7 text-right">
             ...
             <select class="selectpicker show-tick" data-width="auto">
               ...
               <option>Artwork Year(desc.)</option>
               <option>Artwork Year(asc.)</option>
             </select>
        </div>
      </div>
      <div class="row clearfix grid" id="grid">
       <!-- content -->
      </div>
    </div>

            ...
            <ul class="nav navbar-nav navbar-right"> 
              <li class="dropdown">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                      <li> 
                        <a href="#">Chinese Art Center of Pittsburgh</a>                         
                      </li>
                      <li>
                        <a href="#">Children with infantile autism</a>                        
                      </li>
                    </ul>
                </li> 
        ...
        <footer id="footer">
            <div class="container">
                <div class="col-md-6 col-sm-4">
                    ...
                    <p>Asiartique is a art center blalblablabla.</p>
                ...
                <div class="col-md-3 col-sm-6" style="float: right;">
                    ...
                    <a href="#" class="btn btn-small btn-template-main">link to contact page ????</a>
        ...
        <div id="copyright">
            <div class="container">
                <div class="col-md-12">
                    ...
                    <p class="pull-right">Made by <a href="#">Bootstrapious</a> with support from <a href="#">Kakusei</a> 
                    </p>

...
<!--div id="myCarousel" class="carousel slide">
  ...
  <div class="carousel-inner">
    <div class="item active">
      <img src="res/25.jpg" alt="First slide">
      <div class="carousel-caption"><h2>Asiartique: asian artworks and antiques.</h2><h3>Date: Sep.1 2017 </h3></div>
    </div>
    <div class="item">
      <img src="res/2.jpg" alt="Second slide">
      <div class="carousel-caption"></div>
    </div>
    <div class="item">
      <img src="res/3.jpg" alt="Third slide">
      <div class="carousel-caption"></div>
    </div>
  </div>
